import 'package:traveling_app/models/categor.dart';
import 'package:traveling_app/models/trip.dart';

const Categories_data = [//قائمة بالتصنيفات
  Category(
    id: 'c1',
    title: 'جبال',
    imageUrl:
...
const Trips_data = [//قائمة الرحلات. تستخدم لتخزين بيانات الرحلات المتاحة.
  Trip(//مكون يمثل رحلة معينة
    id: 'm1',//معرف الرحلة
    categories: [//قائمة بمعرفات الفئات المرتبطة بالرحلة
      'c1',
    ],
    title: 'جبال الألب',
    tripType: TripType.Exploration,//نوع الرحلة، مثل استكشاف أو أنشطة
    season: Season.Winter,//الموسم المناسب للرحلة
    imageUrl:
    ...
    program: [//قائمة بالخطط أو البرامج للرحلة
    ...
    isInSummer: false,//يوضح ما إذا كانت الرحلة مناسبة للصيف
    isForFamilies: true,
    isInWinter: true,//يوضح ما إذا كانت الرحلة مناسبة للشتاء
  ),
  Trip(
    id: 'm2',
    categories: [
